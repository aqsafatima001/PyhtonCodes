...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            speak("Bot : PIEAS is located in Nilore which is a suburb town 26km from Islamabad.")
        ...
        #     codePath = 'C:\\Users\\Ehsan\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe'
